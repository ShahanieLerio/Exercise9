...
Public rsCustomerTable        As New _
    ADODB.Recordset
...
Public rsCustomer2New         As New _
    ADODB.Recordset
...
Public rsPDCollection         As New _
    ADODB.Recordset
...
Public Sub Location()
    ...
    'ReportPath = _
        '"\\serverpc\lendingv2Melan\app\report\"
            ...
            ServerPath = "C:\Users\User\Documents\For Training Exercises\Exer 9(with NEW DB)\"
                          
    ReportPath = _
        "C:\Users\User\Documents\For Training Exercises\Exer 9(with NEW DB)\Report\"
...
End Sub
Public Sub PastdueCollection()

        '<EhHeader>
        On Error GoTo PDCollection_Err

        '</EhHeader>

100     Set rsPDCollection = Nothing
102     Set rsPDCollection = New ADODB.Recordset

104     With rsPDCollection
106         .CursorType = adOpenDynamic
108         .LockType = adLockOptimistic
110         .ActiveConnection = conn
112         .Source = _
                "Select * from tblPDCollection "
114         .CursorLocation = adUseClient
116         .Open
        End With
...
PDCollection_Err:
        ErrReport Err.Description, _
            "LendingClientV2.DBsetup.PDCollection", _
            Erl
...
Public Sub CustomerTable()
        ...
        '<EhHeader>
        On Error GoTo CustomerTable_Err
...
CustomerTable_Err:
        ErrReport Err.Description, _
            "LendingClientV2.DBsetup.CustomerTable", _
            Erl
...
Public Sub Customer2New()

        '<EhHeader>
        On Error GoTo Customer2New_Err

        '</EhHeader>

100     Set rsCustomer2New = Nothing
102     Set rsCustomer2New = New ADODB.Recordset

104     With rsCustomer2New
106         .CursorType = adOpenDynamic
108         .LockType = adLockOptimistic
110         .ActiveConnection = conn
112         .Source = _
...
Customer2New_Err:
        ErrReport Err.Description, _
            "LendingClientV2.DBsetup.Customer2New", _
            Erl
...
Public Sub Loan2()
        ...
        '<EhHeader>
        On Error GoTo Loan2_Err

        '</EhHeader>

100     Set rsLoan2 = Nothing
102     Set rsLoan2 = New ADODB.Recordset
...
Loan2_Err:
        ErrReport Err.Description, _
            "LendingClientV2.DBsetup.Loan2", Erl
